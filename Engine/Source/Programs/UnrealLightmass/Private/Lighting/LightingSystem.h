...
private:
	...
	/** Utility functions for exporting to GPU solver*/
	void GenerateMapsForGPUSolver();

	void GenerateAndExportMapsForGPUSolverTextureMapping(int32 MappingIndex);

	void ExportAggregateMeshToGPUSolver();

	void ExportSkyCubemapToGPUSolver();

	void ExportPunctualLightsToGPUSolver();

	void SolveRadiosityOnGPU(int32 NumBounces);
	...
	void CalculateVolumetricLightmapBrickSamplesGPU(
	...
	void CalculateVolumeSampleListGPU(
	...
	void PostprocessTextureMapping(FStaticLightingTextureMapping* TextureMapping);
	...
	void CalculateIndirectLightingTextureMappingGPU(
		FStaticLightingTextureMapping* TextureMapping,
		bool bForceFlush);
	...
	volatile int32 NumTexelsNeedToBeProcessedOnGPU;
	TLockFreePointerListLIFO<FStaticLightingTextureMapping> TextureMappingsNeedToBeProcessedOnGPU;
	TLockFreePointerListLIFO<FStaticLightingTextureMapping> TextureMappingsNeedPostprocessing;
