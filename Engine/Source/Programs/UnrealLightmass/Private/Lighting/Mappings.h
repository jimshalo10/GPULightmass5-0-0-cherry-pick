...
public:
	...
	TMap<const FLight*, class FShadowMapData2D*> ShadowMaps;
	TMap<const FLight*, class FSignedDistanceFieldShadowMapData2D*> SignedDistanceFieldShadowMaps;
	class FGatheredLightMapData2D* LightMapData;
};
