...
private:
	...
	TSet<const class FStaticMeshStaticLightingMesh*> StaticMeshLightingMeshes;
	TSet<class FStaticMeshStaticLightingTextureMapping*> StaticMeshTextureMappings;
	...
	TSet<class FStaticLightingGlobalVolumeMapping*> VolumeMappings;
